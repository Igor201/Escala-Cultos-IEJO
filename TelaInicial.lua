...
function scene:create( event )
    ...
    title = display.newText("ESCALA", display.contentCenterX, display.contentCenterY/1.1, "Impact", 60)
    title:setFillColor(0, 0.5, 1 )
    sceneGroup:insert(title)

    title2 = display.newText("IEJO", display.contentCenterX, display.contentCenterY/0.9, "Impact", 60)
